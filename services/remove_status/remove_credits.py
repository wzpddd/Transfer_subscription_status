...
def remove_account_credits(uid_or_email: str, cookies: None):
    ...
    results = api_request(get_remove_credits_api, json=params,cookies=cookies).json()
...
# e057c01e7afa47109fb793db4fb4ba62  wzptestpro02@fotor.com
# dc6db6e93a2149c5b2e465c7005eef29  	wzptestpro03@fotor.com
